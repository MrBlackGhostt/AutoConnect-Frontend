  ...
  const navLinks = [
    {
      name: "Home",
      href: "#hero",
      icon: <Home size={24} strokeWidth={1.5} className="hover:bg-[#EFC727]" />,
    },
    {
      name: "Why Us",
      href: "#why-autoconnect",
      icon: <User size={24} strokeWidth={1.5} className="hover:bg-[#EFC727]" />,
    },
    {
      name: "Features",
      href: "#features",
      icon: (
        <Settings size={24} strokeWidth={1.5} className="hover:bg-[#EFC727]" />
      ),
    },
    {
      name: "Testimonials",
